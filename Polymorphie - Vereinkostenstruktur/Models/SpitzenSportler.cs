...
{
    internal class SpitzenSportler : AktiveMitglied
    {
        public SpitzenSportler(string name, int aktivitatsgrad) : base(name, aktivitatsgrad)
        {
